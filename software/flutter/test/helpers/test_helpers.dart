...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<TemperatureService>(onMissingStub: OnMissingStub.returnDefault),
// @stacked-mock-spec
])
void registerServices() {
  ...
  getAndRegisterTemperatureService();
...
MockTemperatureService getAndRegisterTemperatureService() {
  _removeRegistrationIfExists<TemperatureService>();
  final service = MockTemperatureService();
  locator.registerSingleton<TemperatureService>(service);
  return service;
}
// @stacked-mock-create
